...
const (
	StubType_NORMAL    StubType = 0
	StubType_STATIC    StubType = 1
	StubType_REFERENCE StubType = 2
)

var StubType_name = map[int32]string{
	0: "NORMAL",
	1: "STATIC",
	2: "REFERENCE",
}
var StubType_value = map[string]int32{
	"NORMAL":    0,
	"STATIC":    1,
	"REFERENCE": 2,
}

func (x StubType) String() string {
	return proto.EnumName(StubType_name, int32(x))
}
func (StubType) EnumDescriptor() ([]byte, []int) { return fileDescriptorFlow, []int{1} }
...
func (Link_Kind) EnumDescriptor() ([]byte, []int) { return fileDescriptorFlow, []int{3, 0} }
...
func (Execution_State) EnumDescriptor() ([]byte, []int) { return fileDescriptorFlow, []int{13, 0} }

type FlowReference struct {
	Pipe    string `protobuf:"bytes,1,opt,name=pipe,proto3" json:"pipe,omitempty"`
	Stub    string `protobuf:"bytes,2,opt,name=stub,proto3" json:"stub,omitempty"`
...
func (*FlowReference) Descriptor() ([]byte, []int) { return fileDescriptorFlow, []int{0} }
...
type FlowIn struct {
	...
	// Prev refers to previous stub that modified this flow
	Prev *FlowReference `protobuf:"bytes,7,opt,name=prev" json:"prev,omitempty"`
}

func (m *FlowIn) Reset()                    { *m = FlowIn{} }
func (m *FlowIn) String() string            { return proto.CompactTextString(m) }
func (*FlowIn) ProtoMessage()               {}
func (*FlowIn) Descriptor() ([]byte, []int) { return fileDescriptorFlow, []int{1} }
...
type FlowOut struct {
	...
	Ids map[string]string `protobuf:"bytes,3,rep,name=ids" json:"ids,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Next is used for next stub on static or next pipe on reference stubs
...
func (*FlowOut) Descriptor() ([]byte, []int) { return fileDescriptorFlow, []int{2} }
...
func (*Link) Descriptor() ([]byte, []int) { return fileDescriptorFlow, []int{3} }
...
type Stub struct {
	...
	Type          StubType `protobuf:"varint,7,opt,name=type,proto3,enum=otsimo.StubType" json:"type,omitempty"`
}

func (m *Stub) Reset()                    { *m = Stub{} }
func (m *Stub) String() string            { return proto.CompactTextString(m) }
func (*Stub) ProtoMessage()               {}
func (*Stub) Descriptor() ([]byte, []int) { return fileDescriptorFlow, []int{4} }

type ReferenceStubConfig struct {
	Pipes []string `protobuf:"bytes,1,rep,name=pipes" json:"pipes,omitempty"`
}

func (m *ReferenceStubConfig) Reset()                    { *m = ReferenceStubConfig{} }
func (m *ReferenceStubConfig) String() string            { return proto.CompactTextString(m) }
func (*ReferenceStubConfig) ProtoMessage()               {}
func (*ReferenceStubConfig) Descriptor() ([]byte, []int) { return fileDescriptorFlow, []int{5} }
...
func (*ManualTrigger) Descriptor() ([]byte, []int) { return fileDescriptorFlow, []int{6} }
...
func (*WebhookTrigger) Descriptor() ([]byte, []int) { return fileDescriptorFlow, []int{7} }
...
func (*CronTrigger) Descriptor() ([]byte, []int) { return fileDescriptorFlow, []int{8} }
...
func (*Pipe) Descriptor() ([]byte, []int) { return fileDescriptorFlow, []int{9} }
...
func (*PodServiceAction) Descriptor() ([]byte, []int) { return fileDescriptorFlow, []int{10} }
...
func (*PodServiceConnection) Descriptor() ([]byte, []int) { return fileDescriptorFlow, []int{11} }
...
func (*PodService) Descriptor() ([]byte, []int) { return fileDescriptorFlow, []int{12} }
...
func (*Execution) Descriptor() ([]byte, []int) { return fileDescriptorFlow, []int{13} }
...
func (*Execution_StubExecution) Descriptor() ([]byte, []int) { return fileDescriptorFlow, []int{13, 0} }

func init() {
	proto.RegisterType((*FlowReference)(nil), "otsimo.FlowReference")
	...
	proto.RegisterType((*ReferenceStubConfig)(nil), "otsimo.ReferenceStubConfig")
	...
	proto.RegisterEnum("otsimo.StubType", StubType_name, StubType_value)
...
func (m *FlowReference) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
...
func (m *FlowReference) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.Stub) > 0 {
		data[i] = 0x12
		i++
		i = encodeVarintFlow(data, i, uint64(len(m.Stub)))
		i += copy(data[i:], m.Stub)
	}
	if len(m.Service) > 0 {
		data[i] = 0x1a
		i++
		i = encodeVarintFlow(data, i, uint64(len(m.Service)))
...
func (m *FlowIn) MarshalTo(data []byte) (int, error) {
	...
	if m.Prev != nil {
		data[i] = 0x3a
		i++
		i = encodeVarintFlow(data, i, uint64(m.Prev.Size()))
		n2, err := m.Prev.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n2
...
func (m *ReferenceStubConfig) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *ReferenceStubConfig) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *Pipe) MarshalTo(data []byte) (int, error) {
	...
	if m.Trigger != nil {
		nn5, err := m.Trigger.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn5
...
func (m *Pipe_Manual) MarshalTo(data []byte) (int, error) {
	...
	if m.Manual != nil {
		...
		n6, err := m.Manual.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func (m *FlowReference) Size() (n int) {
	var l int
	_ = l
	l = len(m.Pipe)
	if l > 0 {
...
func (m *ReferenceStubConfig) Size() (n int) {
	var l int
	_ = l
	if len(m.Pipes) > 0 {
		for _, s := range m.Pipes {
...
func (m *FlowReference) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: FlowReference: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FlowReference: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.Stub = string(data[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
...
func (m *ReferenceStubConfig) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReferenceStubConfig: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReferenceStubConfig: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Pipes = append(m.Pipes, string(data[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipFlow(data[iNdEx:])
...
var fileDescriptorFlow = []byte{
	...
	,
}
